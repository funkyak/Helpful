...
def search():
  ...
  #scrapes the individual leters at a set distance ahead 
        back1 = words[words.index(Yesterdays_Wordle)+ - 9]
        back2 = words[words.index(Yesterdays_Wordle)+ - 8]
        back3 = words[words.index(Yesterdays_Wordle)+ - 7]
        back4 = words[words.index(Yesterdays_Wordle)+ - 6]
        back5 = words[words.index(Yesterdays_Wordle)+ - 5]
        before = back1 + back2+ back3 + back4 + back5
  ...
  #Output 
        ...
        print("")
        print("Day before wordle is : " + before)
        print("")
